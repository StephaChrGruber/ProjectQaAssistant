...
export async function GET(
    ...
    const upstream = new URL(`${BACKEND}/admin/custom-tools/${encodeURIComponent(toolId)}/versions`)
...
export async function POST(
    ...
    const res = await fetch(`${BACKEND}/admin/custom-tools/${encodeURIComponent(toolId)}/versions`, {
        method: "POST",
